...
int main()
{
    ...
    CGameState game(CPlayer(CCardPack("J^ Q^   7+ 9+   1$ J$ Q$ K$   7@ J@"), PS_P2MAX),
                    CPlayer(CCardPack("7^ 8^ 9^ 1^   8+   7$ 8$ 9$   8@ 9@"), PS_P2MIN),
                    CPlayer(CCardPack("K^ A^   1+ J+ Q+   A$   1@ Q@ K@ A@"), PS_P2MAX));
